#ifndef AVEL_COMPARISON_EQUALS_32U_HPP
#define AVEL_COMPARISON_EQUALS_32U_HPP

namespace avel::benchmarks::comparison_equals_32u {
    ...
    BENCHMARK(comparison_equals_32u::scalar_native);
    ...
    mask4x32u vec4x32u_cmpeqd_impl(vec4x32u lhs, vec4x32u rhs) {
        return mask4x32u{_mm_cmpeq_epi32(decay(lhs), decay(rhs))};
    }

    auto vec4x32u_cmpeqd = vector_comparison_test_bench<vec4x32u, vec4x32u_cmpeqd_impl>;

    BENCHMARK(comparison_equals_32u::vec4x32u_cmpeqd);
    ...
    mask4x32u vec4x32u_cmpeqd_k_impl(vec4x32u lhs, vec4x32u rhs) {
        return mask4x32u{_mm_cmp_epi32_mask(decay(lhs), decay(rhs), _MM_CMPINT_EQ)};
    }

    auto vec4x32u_cmpeqd_k = vector_comparison_test_bench<vec4x32u, vec4x32u_cmpeqd_k_impl>;

    BENCHMARK(comparison_equals_32u::vec4x32u_cmpeqd_k);
    ...
    mask8x32u vec8x32u_cmpeqd_impl(vec8x32u lhs, vec8x32u rhs) {
        return mask8x32u{_mm256_cmpeq_epi32(decay(lhs), decay(rhs))};
    }

    auto vec8x32u_cmpeqd = vector_comparison_test_bench<vec8x32u, vec8x32u_cmpeqd_impl>;

    BENCHMARK(comparison_equals_32u::vec8x32u_cmpeqd);
    ...
    mask8x32u vec8x32u_cmpeqd_k_impl(vec8x32u lhs, vec8x32u rhs) {
        return mask8x32u{_mm256_cmp_epi32_mask(decay(lhs), decay(rhs), _MM_CMPINT_EQ)};
    }

    auto vec8x32u_cmpeqd_k = vector_comparison_test_bench<vec8x32u, vec8x32u_cmpeqd_k_impl>;

    BENCHMARK(comparison_equals_32u::vec8x32u_cmpeqd_k);
    ...
    mask16x32u vec16x32u_cmpeqd_k_impl(vec16x32u lhs, vec16x32u rhs) {
        return mask16x32u{_mm512_cmp_epi32_mask(decay(lhs), decay(rhs), _MM_CMPINT_EQ)};
    }

    auto vec16x32u_cmpeqd_k = vector_comparison_test_bench<vec16x32u, vec16x32u_cmpeqd_k_impl>;

    BENCHMARK(comparison_equals_32u::vec16x32u_cmpeqd_k);

    #endif

}

#endif //AVEL_COMPARISON_EQUALS_32U_HPP
