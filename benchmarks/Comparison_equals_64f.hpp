...
namespace avel::benchmarks::comparison_equals_64f {
    ...
    mask2x64f vec2x64f_cmppd_impl(vec2x64f lhs, vec2x64f rhs) {
        return mask2x64f{_mm_cmpeq_pd(decay(lhs), decay(rhs))};
    }
    ...
    mask2x64f vec2x64f_cmpeqd_k_impl(vec2x64f lhs, vec2x64f rhs) {
        return mask2x64f{_mm_cmp_pd_mask(decay(lhs), decay(rhs), _CMP_EQ_OS)};
    }

    auto vec2x64f_cmpeqd_k = vector_comparison_test_bench<vec2x64f, vec2x64f_cmpeqd_k_impl>;

    BENCHMARK(comparison_equals_64f::vec2x64f_cmpeqd_k);
    ...
    mask4x64f vec4x64f_cmppd_impl(vec4x64f lhs, vec4x64f rhs) {
        return mask4x64f{_mm256_cmp_pd(decay(lhs), decay(rhs), _CMP_EQ_OS)};
    }

    auto vec4x64f_cmpeqd = vector_comparison_test_bench<vec4x64f, vec4x64f_cmppd_impl>;

    BENCHMARK(comparison_equals_64f::vec4x64f_cmpeqd);
    ...
    mask4x64f vec4x64f_vcmppd_impl(vec4x64f lhs, vec4x64f rhs) {
        return mask4x64f{_mm256_cmp_pd_mask(decay(lhs), decay(rhs), _CMP_EQ_OS)};
    }
    ...
    mask8x64f vec8x64f_vcmppd_impl(vec8x64f lhs, vec8x64f rhs) {
        return mask8x64f{_mm512_cmp_pd_mask(decay(lhs), decay(rhs), _CMP_EQ_OS)};
    }
