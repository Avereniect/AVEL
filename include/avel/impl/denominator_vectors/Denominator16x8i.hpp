...
namespace avel {
    ...
    public:
        ...
        AVEL_FINL Denom16x8i& operator<<=(vec16x8i s) {
            auto effective_s = avel::max(avel::countl_sign(d), s);
        ...
        [[nodiscard]]
        AVEL_FINL Denom16x8i operator<<(vec16x8i s) const {
            Denom16x8i ret = *this;
            ret <<= s;
        ...
        [[nodiscard]]
        AVEL_FINL vec16x8i value() const {
            return d;
        }
