...
namespace avel {
    ...
    public:
        ...
        AVEL_FINL Denom2x64u& operator<<=(vec2x64u s) {
        ...
        [[nodiscard]]
        AVEL_FINL Denom2x64u operator<<(vec2x64u s) const {
            Denom2x64u ret = *this;
            ret <<= s;
    ...
    private:
        ...
        static vec2x64u mulhi(vec2x64u x, vec2x64u y) {
            ...
            auto prod = _mm_unpackhi_epi64(prod0, prod1);
            auto ret =  vec2x64u{prod} + t1 + t2;
            return ret;
