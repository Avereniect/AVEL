...
namespace avel {
    ...
    public:
        ...
        AVEL_FINL Denom32x16u& operator<<=(vec32x16u s) {
        ...
        [[nodiscard]]
        AVEL_FINL Denom32x16u operator<<(vec32x16u s) const {
            Denom32x16u ret = *this;
            ret <<= s;
        ...
        [[nodiscard]]
        AVEL_FINL vec32x16u value() const {
            return d;
        }
