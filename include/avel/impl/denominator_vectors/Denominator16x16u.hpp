...
namespace avel {
    ...
    public:
        ...
        AVEL_FINL Denom16x16u& operator<<=(vec16x16u s) {
        ...
        [[nodiscard]]
        AVEL_FINL Denom16x16u operator<<(vec16x16u s) const {
            Denom16x16u ret = *this;
            ret <<= s;
        ...
        [[nodiscard]]
        AVEL_FINL vec16x16u value() const {
            return d;
        }
