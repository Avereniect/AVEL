...
namespace avel {
    ...
    public:
        ...
        AVEL_FINL Denom16x32u& operator<<=(vec16x32u s) {
        ...
        [[nodiscard]]
        AVEL_FINL Denom16x32u operator<<(vec16x32u s) const {
            Denom16x32u ret = *this;
            ret <<= s;
        ...
        [[nodiscard]]
        AVEL_FINL vec16x32u value() const {
            return d;
        }
