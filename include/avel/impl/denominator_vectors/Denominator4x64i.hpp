...
namespace avel {
    ...
    public:
        ...
        AVEL_FINL Denom4x64i& operator<<=(vec4x64i s) {
        ...
        [[nodiscard]]
        AVEL_FINL Denom4x64i operator<<(vec4x64i s) const {
            Denom4x64i ret = *this;
            ret <<= s;
        ...
        [[nodiscard]]
        AVEL_FINL vec4x64i value() const {
            return d;
        }
    ...
    private:
        ...
        static vec4x64i mulhi(vec4x64i x, vec4x64i y) {
            ...
            auto ret = _mm256_unpackhi_epi64(prod0, prod1);
            return vec4x64i{ret};
