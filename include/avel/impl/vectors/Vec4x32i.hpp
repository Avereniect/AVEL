namespace avel {
    ...
    public:
        ...
        AVEL_FINL bool operator[](int i) const {
            ...
            //TODO: Optimize
            switch (i) {
            case 0: return vgetq_lane_s32(content, 0);
            case 1: return vgetq_lane_s32(content, 1);
            case 2: return vgetq_lane_s32(content, 2);
            case 3: return vgetq_lane_s32(content, 3);
            }
            #endif
        }
