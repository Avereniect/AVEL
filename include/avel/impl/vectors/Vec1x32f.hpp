...
namespace avel {
    ...
    AVEL_FINL vec1x32f blend(mask1x32f, vec1x32f, vec1x32f);
    ...
    public:
        ...
        explicit Vector_mask(primitive p):
            content(p & 0x1) {}
    ...
    */
    ...
    public:
        ...
        AVEL_FINL explicit Vector(const arr1x32f& array) {
            content = array[0];
        }
    ...
    /*
    [[nodiscard]]
    AVEL_FINL vec1x32f broadcast_mask(mask1x32f m) {
    ...
    AVEL_FINL vec1x32f blend(mask1x32f m, vec1x32f a, vec1x32f b) {
        return vec1x32f{blend(decay(m), decay(a), decay(b)};
    }
    ...
    */
    ...
    /*
    [[nodiscard]]
    AVEL_FINL arr1x32f to_array(vec1x32f x) {
        alignas(4) arr1x32f array{};
