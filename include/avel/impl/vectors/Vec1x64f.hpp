...
namespace avel {
    ...
    AVEL_FINL vec1x64f blend(vec1x64f, vec1x64f, mask1x64f);
    ...
    */
    ...
    [[nodiscard]]
    AVEL_FINL vec1x64f broadcast_bits(mask1x64f m) {
        //TODO: Implement
    }

    [[nodiscard]]
    AVEL_FINL vec1x64f blend(vec1x64f a, vec1x64f b, mask1x64f m) {
        //TODO: Implement
    }
