...
namespace avel {
    ...
    alignas(256) constexpr std::uint8_t isqrt_table_data[256] {
        0x0, 0x1, 0x1, 0x1, 0x2, 0x2, 0x2, 0x2,
    ...
    //=====================================================
    // pshufb lookup tables for 8-bit integers
    //=====================================================

    alignas(16) constexpr std::uint8_t isqrt_table_data0[16] {
        0x00, 0x01, 0x01, 0x01,
        0x02, 0x02, 0x02, 0x02,
        0x02, 0x03, 0x03, 0x03,
        0x03, 0x03, 0x03, 0x03
    ...
    alignas(16) constexpr std::uint8_t isqrt_table_data1[16] {
        0x00 | 0xf0, 0x04 | 0x80, 0x05 | 0x30, 0x06 | 0x00,
        0x08 | 0xf0, 0x08 | 0x00, 0x09 | 0x30, 0x0a | 0x80,
        0x0b | 0xf0, 0x0c | 0xf0, 0x0c | 0x80, 0x0d | 0xf0,
        0x0d | 0x30, 0x0e | 0xf0, 0x0e | 0x00, 0x0f | 0xf0
    };
